...
const trust = [
  {
    ...
    desc: "Ranked #1 Franchise Consultant by Franchise India for 4 years.",
  },
  {
    icon: FiUsers,
    title: "Expert Team",
    desc: "50+ dedicated franchise specialists, legal experts, and marketing professionals.",
  },
  {
    icon: FiGlobe,
    title: "Pan-India Network",
    desc: "Established presence across 28 states with on-ground support teams.",
  },
  {
    icon: FiTrendingUp,
    title: "Proven Results",
    desc: "500+ brands scaled. Average franchise time-to-market reduced by 40%.",
  },
];
    ...
    <>
      ...
      <div className="relative bg-primary pt-32 pb-20 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=70')`,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-white/75 text-lg">
              Since 2012, iFranchise has been the trusted growth partner for
              entrepreneurs and businesses looking to build resilient franchise
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            <h2 className="font-display font-bold text-3xl md:text-4xl text-dark mb-5">
              From a Vision to{" "}
              <span className="text-gradient">India&apos;s Leading</span>{" "}
              Franchise Consultancy
            </h2>
            <p className="text-gray-500 leading-relaxed mb-4">
              Founded in 2012 by seasoned entrepreneurs and business
              strategists, iFranchise was born from a simple belief: every great
              brand deserves the right partner to scale. We saw too many
              promising businesses fail to expand due to lack of structured
              systems, investor access, and expertise.
            </p>
            <p className="text-gray-500 leading-relaxed mb-6">
              Today, with a team of 50+ specialists and a network spanning 28
              states, we&apos;ve become the go-to partner for brands seeking
              sustainable, profitable franchise growth.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed">
                To democratize business growth by making franchise development
                accessible, transparent, and successful for every brand — from
                startups to established enterprises — across India and beyond.
              </p>
            </motion.div>
            <motion.div
              variants={fadeUp}
            ...
            >
              ...
              <p className="text-white/80 leading-relaxed">
                To be the most trusted franchise ecosystem in South Asia — where
                brands grow confidently, investors thrive, and franchise
                partners build lasting businesses that create employment and
                value.
              </p>
            </motion.div>
          </div>
      ...
      <SectionWrapper>
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="max-w-3xl mx-auto bg-accent/50 rounded-2xl p-8 md:p-12 text-center border border-accent"
          >
            ...
            <blockquote className="text-dark/80 text-lg leading-relaxed italic mb-6">
              &ldquo;We built iFranchise because we knew the franchise model
              could transform India&apos;s business landscape. Every brand we
              scale, every investor we empower, brings us closer to that vision.
              We are not just consultants — we are growth partners for
              life.&rdquo;
            </blockquote>
